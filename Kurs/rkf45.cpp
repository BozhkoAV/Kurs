...
void FEHL(void (*F)(float t1, float* y1, float* dy1), int NEQN,
	float* Y, float* T, float* H, float* YP,
...
void RKFS(void (*F)(float t1, float* y1, float* dy1), int NEQN,
	float* Y, float* T, float* TOUT,
	float* RELERR, float* ABSERR, int* IFLAG,
	float* YP, float* H, float* F1, float* F2,
	float* F3, float* F4, float* F5, float* SAVRE,
	float* SAVAE, int* NFE, int* KOP, int* INIT, int* JFLAG,
	int* KFLAG)
{
